(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-bias-cut-skirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-bias-cut-skirts-assistant-messages]');
    var form = root.querySelector('[data-bias-cut-skirts-assistant-form]');
    var input = root.querySelector('[data-bias-cut-skirts-assistant-input]');
    var fileInput = root.querySelector('[data-bias-cut-skirts-assistant-file]');
    var photoButton = root.querySelector('[data-bias-cut-skirts-assistant-photo]');
    var sendButton = root.querySelector('[data-bias-cut-skirts-assistant-send]');
    var previewsEl = root.querySelector('[data-bias-cut-skirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: юбка по косой';
