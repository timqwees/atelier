(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-cutoff-assistant]');
    ...
    var messagesEl = root.querySelector('[data-cutoff-assistant-messages]');
    var form = root.querySelector('[data-cutoff-assistant-form]');
    var input = root.querySelector('[data-cutoff-assistant-input]');
    var fileInput = root.querySelector('[data-cutoff-assistant-file]');
    var photoButton = root.querySelector('[data-cutoff-assistant-photo]');
    var sendButton = root.querySelector('[data-cutoff-assistant-send]');
    var previewsEl = root.querySelector('[data-cutoff-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки платья с отрезной талией';
