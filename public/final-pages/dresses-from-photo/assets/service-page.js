(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-dresses-from-photo-assistant]');
    ...
    var messagesEl = root.querySelector('[data-dresses-from-photo-assistant-messages]');
    var form = root.querySelector('[data-dresses-from-photo-assistant-form]');
    var input = root.querySelector('[data-dresses-from-photo-assistant-input]');
    var fileInput = root.querySelector('[data-dresses-from-photo-assistant-file]');
    var photoButton = root.querySelector('[data-dresses-from-photo-assistant-photo]');
    var sendButton = root.querySelector('[data-dresses-from-photo-assistant-send]');
    var previewsEl = root.querySelector('[data-dresses-from-photo-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: платье по фото';
