(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-evening-assistant]');
    ...
    var messagesEl = root.querySelector('[data-evening-assistant-messages]');
    var form = root.querySelector('[data-evening-assistant-form]');
    var input = root.querySelector('[data-evening-assistant-input]');
    var fileInput = root.querySelector('[data-evening-assistant-file]');
    var photoButton = root.querySelector('[data-evening-assistant-photo]');
    var sendButton = root.querySelector('[data-evening-assistant-send]');
    var previewsEl = root.querySelector('[data-evening-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки вечернего платья';
