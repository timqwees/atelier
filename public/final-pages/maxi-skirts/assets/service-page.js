(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-maxi-skirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-maxi-skirts-assistant-messages]');
    var form = root.querySelector('[data-maxi-skirts-assistant-form]');
    var input = root.querySelector('[data-maxi-skirts-assistant-input]');
    var fileInput = root.querySelector('[data-maxi-skirts-assistant-file]');
    var photoButton = root.querySelector('[data-maxi-skirts-assistant-photo]');
    var sendButton = root.querySelector('[data-maxi-skirts-assistant-send]');
    var previewsEl = root.querySelector('[data-maxi-skirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: макси-юбка';
