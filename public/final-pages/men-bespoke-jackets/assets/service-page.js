(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-jackets-assistant]');
    ...
    var messagesEl = root.querySelector('[data-jackets-assistant-messages]');
    var form = root.querySelector('[data-jackets-assistant-form]');
    var input = root.querySelector('[data-jackets-assistant-input]');
    var fileInput = root.querySelector('[data-jackets-assistant-file]');
    var photoButton = root.querySelector('[data-jackets-assistant-photo]');
    var sendButton = root.querySelector('[data-jackets-assistant-send]');
    var previewsEl = root.querySelector('[data-jackets-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: классический пиджак';
