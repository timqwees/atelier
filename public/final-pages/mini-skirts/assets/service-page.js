(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-mini-skirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-mini-skirts-assistant-messages]');
    var form = root.querySelector('[data-mini-skirts-assistant-form]');
    var input = root.querySelector('[data-mini-skirts-assistant-input]');
    var fileInput = root.querySelector('[data-mini-skirts-assistant-file]');
    var photoButton = root.querySelector('[data-mini-skirts-assistant-photo]');
    var sendButton = root.querySelector('[data-mini-skirts-assistant-send]');
    var previewsEl = root.querySelector('[data-mini-skirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: мини-юбка';
