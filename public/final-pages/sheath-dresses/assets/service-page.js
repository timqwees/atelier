(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-sheath-assistant]');
    ...
    var messagesEl = root.querySelector('[data-sheath-assistant-messages]');
    var form = root.querySelector('[data-sheath-assistant-form]');
    var input = root.querySelector('[data-sheath-assistant-input]');
    var fileInput = root.querySelector('[data-sheath-assistant-file]');
    var photoButton = root.querySelector('[data-sheath-assistant-photo]');
    var sendButton = root.querySelector('[data-sheath-assistant-send]');
    var previewsEl = root.querySelector('[data-sheath-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки платья-футляра';
