(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-straight-assistant]');
    ...
    var messagesEl = root.querySelector('[data-straight-assistant-messages]');
    var form = root.querySelector('[data-straight-assistant-form]');
    var input = root.querySelector('[data-straight-assistant-input]');
    var fileInput = root.querySelector('[data-straight-assistant-file]');
    var photoButton = root.querySelector('[data-straight-assistant-photo]');
    var sendButton = root.querySelector('[data-straight-assistant-send]');
    var previewsEl = root.querySelector('[data-straight-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки прямого платья';
