(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-straight-skirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-straight-skirts-assistant-messages]');
    var form = root.querySelector('[data-straight-skirts-assistant-form]');
    var input = root.querySelector('[data-straight-skirts-assistant-input]');
    var fileInput = root.querySelector('[data-straight-skirts-assistant-file]');
    var photoButton = root.querySelector('[data-straight-skirts-assistant-photo]');
    var sendButton = root.querySelector('[data-straight-skirts-assistant-send]');
    var previewsEl = root.querySelector('[data-straight-skirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: прямая юбка';
