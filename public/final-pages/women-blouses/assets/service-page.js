(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-blouses-assistant]');
    ...
    var messagesEl = root.querySelector('[data-blouses-assistant-messages]');
    var form = root.querySelector('[data-blouses-assistant-form]');
    var input = root.querySelector('[data-blouses-assistant-input]');
    var fileInput = root.querySelector('[data-blouses-assistant-file]');
    var photoButton = root.querySelector('[data-blouses-assistant-photo]');
    var sendButton = root.querySelector('[data-blouses-assistant-send]');
    var previewsEl = root.querySelector('[data-blouses-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: блуза';
