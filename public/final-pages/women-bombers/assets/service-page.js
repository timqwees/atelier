(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-bombers-assistant]');
    ...
    var messagesEl = root.querySelector('[data-bombers-assistant-messages]');
    var form = root.querySelector('[data-bombers-assistant-form]');
    var input = root.querySelector('[data-bombers-assistant-input]');
    var fileInput = root.querySelector('[data-bombers-assistant-file]');
    var photoButton = root.querySelector('[data-bombers-assistant-photo]');
    var sendButton = root.querySelector('[data-bombers-assistant-send]');
    var previewsEl = root.querySelector('[data-bombers-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: бомбер';
