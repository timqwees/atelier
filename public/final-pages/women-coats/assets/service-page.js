(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-coats-assistant]');
    ...
    var messagesEl = root.querySelector('[data-coats-assistant-messages]');
    var form = root.querySelector('[data-coats-assistant-form]');
    var input = root.querySelector('[data-coats-assistant-input]');
    var fileInput = root.querySelector('[data-coats-assistant-file]');
    var photoButton = root.querySelector('[data-coats-assistant-photo]');
    var sendButton = root.querySelector('[data-coats-assistant-send]');
    var previewsEl = root.querySelector('[data-coats-assistant-previews]');
    var conversation = [];
