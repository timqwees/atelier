(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-corsets-assistant]');
    ...
    var messagesEl = root.querySelector('[data-corsets-assistant-messages]');
    var form = root.querySelector('[data-corsets-assistant-form]');
    var input = root.querySelector('[data-corsets-assistant-input]');
    var fileInput = root.querySelector('[data-corsets-assistant-file]');
    var photoButton = root.querySelector('[data-corsets-assistant-photo]');
    var sendButton = root.querySelector('[data-corsets-assistant-send]');
    var previewsEl = root.querySelector('[data-corsets-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: корсет';
