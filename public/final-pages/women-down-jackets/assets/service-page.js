(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-down-jackets-assistant]');
    ...
    var messagesEl = root.querySelector('[data-down-jackets-assistant-messages]');
    var form = root.querySelector('[data-down-jackets-assistant-form]');
    var input = root.querySelector('[data-down-jackets-assistant-input]');
    var fileInput = root.querySelector('[data-down-jackets-assistant-file]');
    var photoButton = root.querySelector('[data-down-jackets-assistant-photo]');
    var sendButton = root.querySelector('[data-down-jackets-assistant-send]');
    var previewsEl = root.querySelector('[data-down-jackets-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: пуховик';
