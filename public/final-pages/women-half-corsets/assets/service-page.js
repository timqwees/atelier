(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-half-corsets-assistant]');
    ...
    var messagesEl = root.querySelector('[data-half-corsets-assistant-messages]');
    var form = root.querySelector('[data-half-corsets-assistant-form]');
    var input = root.querySelector('[data-half-corsets-assistant-input]');
    var fileInput = root.querySelector('[data-half-corsets-assistant-file]');
    var photoButton = root.querySelector('[data-half-corsets-assistant-photo]');
    var sendButton = root.querySelector('[data-half-corsets-assistant-send]');
    var previewsEl = root.querySelector('[data-half-corsets-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: полукорсет';
