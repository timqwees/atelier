(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-hoodies-assistant]');
    ...
    var messagesEl = root.querySelector('[data-hoodies-assistant-messages]');
    var form = root.querySelector('[data-hoodies-assistant-form]');
    var input = root.querySelector('[data-hoodies-assistant-input]');
    var fileInput = root.querySelector('[data-hoodies-assistant-file]');
    var photoButton = root.querySelector('[data-hoodies-assistant-photo]');
    var sendButton = root.querySelector('[data-hoodies-assistant-send]');
    var previewsEl = root.querySelector('[data-hoodies-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: худи';
