(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-long-sleeves-assistant]');
    ...
    var messagesEl = root.querySelector('[data-long-sleeves-assistant-messages]');
    var form = root.querySelector('[data-long-sleeves-assistant-form]');
    var input = root.querySelector('[data-long-sleeves-assistant-input]');
    var fileInput = root.querySelector('[data-long-sleeves-assistant-file]');
    var photoButton = root.querySelector('[data-long-sleeves-assistant-photo]');
    var sendButton = root.querySelector('[data-long-sleeves-assistant-send]');
    var previewsEl = root.querySelector('[data-long-sleeves-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: лонгслив';
