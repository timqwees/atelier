(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-outerwear-jackets-assistant]');
    ...
    var messagesEl = root.querySelector('[data-outerwear-jackets-assistant-messages]');
    var form = root.querySelector('[data-outerwear-jackets-assistant-form]');
    var input = root.querySelector('[data-outerwear-jackets-assistant-input]');
    var fileInput = root.querySelector('[data-outerwear-jackets-assistant-file]');
    var photoButton = root.querySelector('[data-outerwear-jackets-assistant-photo]');
    var sendButton = root.querySelector('[data-outerwear-jackets-assistant-send]');
    var previewsEl = root.querySelector('[data-outerwear-jackets-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: женская куртка';
