(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-parkas-assistant]');
    ...
    var messagesEl = root.querySelector('[data-parkas-assistant-messages]');
    var form = root.querySelector('[data-parkas-assistant-form]');
    var input = root.querySelector('[data-parkas-assistant-input]');
    var fileInput = root.querySelector('[data-parkas-assistant-file]');
    var photoButton = root.querySelector('[data-parkas-assistant-photo]');
    var sendButton = root.querySelector('[data-parkas-assistant-send]');
    var previewsEl = root.querySelector('[data-parkas-assistant-previews]');
    var conversation = [];
