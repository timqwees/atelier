(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-shearling-coats-assistant]');
    ...
    var messagesEl = root.querySelector('[data-shearling-coats-assistant-messages]');
    var form = root.querySelector('[data-shearling-coats-assistant-form]');
    var input = root.querySelector('[data-shearling-coats-assistant-input]');
    var fileInput = root.querySelector('[data-shearling-coats-assistant-file]');
    var photoButton = root.querySelector('[data-shearling-coats-assistant-photo]');
    var sendButton = root.querySelector('[data-shearling-coats-assistant-send]');
    var previewsEl = root.querySelector('[data-shearling-coats-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: дубленка';
