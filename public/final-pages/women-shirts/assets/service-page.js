(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-shirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-shirts-assistant-messages]');
    var form = root.querySelector('[data-shirts-assistant-form]');
    var input = root.querySelector('[data-shirts-assistant-input]');
    var fileInput = root.querySelector('[data-shirts-assistant-file]');
    var photoButton = root.querySelector('[data-shirts-assistant-photo]');
    var sendButton = root.querySelector('[data-shirts-assistant-send]');
    var previewsEl = root.querySelector('[data-shirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: женская рубашка';
