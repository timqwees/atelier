(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-sweatshirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-sweatshirts-assistant-messages]');
    var form = root.querySelector('[data-sweatshirts-assistant-form]');
    var input = root.querySelector('[data-sweatshirts-assistant-input]');
    var fileInput = root.querySelector('[data-sweatshirts-assistant-file]');
    var photoButton = root.querySelector('[data-sweatshirts-assistant-photo]');
    var sendButton = root.querySelector('[data-sweatshirts-assistant-send]');
    var previewsEl = root.querySelector('[data-sweatshirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: свитшот';
