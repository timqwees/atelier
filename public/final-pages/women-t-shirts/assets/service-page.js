(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-t-shirts-assistant]');
    ...
    var messagesEl = root.querySelector('[data-t-shirts-assistant-messages]');
    var form = root.querySelector('[data-t-shirts-assistant-form]');
    var input = root.querySelector('[data-t-shirts-assistant-input]');
    var fileInput = root.querySelector('[data-t-shirts-assistant-file]');
    var photoButton = root.querySelector('[data-t-shirts-assistant-photo]');
    var sendButton = root.querySelector('[data-t-shirts-assistant-send]');
    var previewsEl = root.querySelector('[data-t-shirts-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: футболка';
