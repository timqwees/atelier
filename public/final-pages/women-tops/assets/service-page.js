(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-tops-assistant]');
    ...
    var messagesEl = root.querySelector('[data-tops-assistant-messages]');
    var form = root.querySelector('[data-tops-assistant-form]');
    var input = root.querySelector('[data-tops-assistant-input]');
    var fileInput = root.querySelector('[data-tops-assistant-file]');
    var photoButton = root.querySelector('[data-tops-assistant-photo]');
    var sendButton = root.querySelector('[data-tops-assistant-send]');
    var previewsEl = root.querySelector('[data-tops-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: топ';
