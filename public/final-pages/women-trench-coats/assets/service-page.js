(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-trench-coats-assistant]');
    ...
    var messagesEl = root.querySelector('[data-trench-coats-assistant-messages]');
    var form = root.querySelector('[data-trench-coats-assistant-form]');
    var input = root.querySelector('[data-trench-coats-assistant-input]');
    var fileInput = root.querySelector('[data-trench-coats-assistant-file]');
    var photoButton = root.querySelector('[data-trench-coats-assistant-photo]');
    var sendButton = root.querySelector('[data-trench-coats-assistant-send]');
    var previewsEl = root.querySelector('[data-trench-coats-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: плащ';
