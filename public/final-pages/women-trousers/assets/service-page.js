(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-trousers-assistant]');
    ...
    var messagesEl = root.querySelector('[data-trousers-assistant-messages]');
    var form = root.querySelector('[data-trousers-assistant-form]');
    var input = root.querySelector('[data-trousers-assistant-input]');
    var fileInput = root.querySelector('[data-trousers-assistant-file]');
    var photoButton = root.querySelector('[data-trousers-assistant-photo]');
    var sendButton = root.querySelector('[data-trousers-assistant-send]');
    var previewsEl = root.querySelector('[data-trousers-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: женские брюки';
