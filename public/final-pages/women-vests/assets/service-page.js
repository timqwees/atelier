(function () {
  ...
  function initHeroAssistant() {
    var root = document.querySelector('[data-vests-assistant]');
    ...
    var messagesEl = root.querySelector('[data-vests-assistant-messages]');
    var form = root.querySelector('[data-vests-assistant-form]');
    var input = root.querySelector('[data-vests-assistant-input]');
    var fileInput = root.querySelector('[data-vests-assistant-file]');
    var photoButton = root.querySelector('[data-vests-assistant-photo]');
    var sendButton = root.querySelector('[data-vests-assistant-send]');
    var previewsEl = root.querySelector('[data-vests-assistant-previews]');
    var conversation = [];
    ...
    function send() {
      ...
      var userText = text || 'Фото для оценки: жилет';
