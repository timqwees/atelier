...
function generateHtml(page, copy) {
  ...
  html = html
    ...
    .replace(/Опишите платье или прикрепите фото референса\. Я задам уточняющие вопросы и посчитаю ориентир по пошиву\./g, `Опишите ${copy.accusative} или прикрепите фото референса. Я задам уточняющие вопросы и посчитаю ориентир по пошиву.`)
