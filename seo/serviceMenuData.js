...
const womenDressSubcategories = [
  ...
  },
  {
    ...
    slug: 'wedding',
    type: 'service-subcategory',
    seoTitle: 'Пошив свадебных платьев на заказ в Москве — Ателье 15/13',
    seoDescription: 'Индивидуальный пошив свадебных платьев на заказ в Москве. Премиум-ткани, кружево, шёлк, идеальная посадка по фигуре. От 90 000 ₽.',
    h1: 'Индивидуальный пошив свадебных платьев',
    introText: 'Свадебное платье — главный элемент образа невесты. Ателье 15/13 создаёт силуэт, посадку и детали под фигуру, ткань и формат торжества. Работаем с премиальными тканями, кружевом и сложными конструкциями.',
    heroUsp: 'Рассчитайте предварительную стоимость пошива на сайте и приходите на консультацию с готовым ориентиром.',
    availableOptions: [
      'Свадебное платье по индивидуальным меркам',
      'Платье для свадьбы, венчания или свадебного ужина',
      'Пошив по фото, эскизу или референсу бренда',
      'Работа с кружевом, шёлком, атласом и сложными тканями',
      'Индивидуальная посадка, лиф, юбка, длина и декор',
    ],
    materials: [
      'Шёлк',
      'Атлас',
    ...
    galleryItems: [
      {
        title: 'Силуэт свадебного платья',
        description: 'Ориентир по форме, длине и общему характеру будущего изделия.',
        image: '/images/craftsmanship.png',
      },
      {
        title: 'Посадка по фигуре',
        description: 'Работа с лифом, юбкой, линией талии и комфортом в движении.',
        image: '/images/measurement.png',
      },
      {
        title: 'Детали пошива',
        description: 'Кружево, ткань, отделка и ручные элементы крупным планом.',
        image: '/images/fabrics.png',
      },
    ],
    whyItems: [
      {
        title: 'Посадка',
        description: 'Платье строится под вашу фигуру и сценарий свадьбы, чтобы силуэт выглядел безупречно в течение всего дня.',
      },
      {
        title: 'Качество',
        description: 'Конструкция, ткань, подкладка и отделка подбираются под задачу: от лаконичного платья до сложного торжественного образа.',
      },
      {
        title: 'Уровень luxury brand',
        description: 'Фокус на чистой линии, материале и деталях, которые делают платье индивидуальным и запоминающимся.',
      },
    ],
    pricingFactors: [
      {
      ...
      {
        title: 'Ткань и кружево',
        description: 'Шёлк, атлас, кружево, органза и сложные материалы требуют разной обработки.',
      },
      {
        title: 'Декор и ручная работа',
        description: 'Вышивка, пайетки, кружево, аппликации и ручные элементы рассчитываются отдельно.',
    ...
    priceFrom: 90000,
    priceNote: 'Стоимость пошива свадебного платья — от 90 000 ₽. Итоговая цена зависит от ткани, кружева, конструкции, декора, подкладки, сроков и количества примерок.',
    processSteps: [
      'Консультация: обсуждаем формат свадьбы, силуэт, референсы и желаемый образ',
      'Мерки и материалы: подбираем ткань, кружево, подкладку и фурнитуру',
      'Конструирование: создаём основу изделия под фигуру и сценарий дня',
      'Пошив и примерки: уточняем посадку, длину, линию талии и детали',
      'Финальная готовность: проверяем посадку, обработку и комфорт перед свадьбой',
    ],
    faq: [
      {
        question: 'Сколько стоит пошив свадебного платья?',
        answer: 'Стоимость пошива свадебного платья начинается от 90 000 ₽. Точная цена зависит от ткани, кружева, конструкции, декора и сроков изготовления.',
      },
      {
        question: 'Сколько времени занимает пошив свадебного платья?',
        answer: 'Стандартный срок пошива свадебного платья — 6–8 недель. При необходимости возможен срочный пошив с доплатой.',
      },
      {
        question: 'Можно ли сшить свадебное платье по фото или референсу?',
        answer: 'Да, фото или референс можно использовать как основу для силуэта, настроения, деталей и пропорций будущего платья.',
      },
      {
        question: 'Работаете ли вы с кружевом и сложными тканями?',
        answer: 'Да, ателье работает с кружевом, шёлком, атласом, органзой и другими премиальными материалами для свадебных платьев.',
      },
    ],
    relatedPages: [],
  },
...
const womenCategories = [
  ...
  { title: 'Джинсы', slug: 'jeans', type: 'garment-category' },
...
const menCategories = [
  { title: 'Костюмы', slug: 'suits', type: 'garment-category' },
...
const womenAlterationCategories = [
  ...
  { title: 'Трикотаж', slug: 'knitwear', genitive: 'женского трикотажа' },
...
export const serviceMenuData = createNode({
  ...
  children: [
    ...
    },
    {
      ...
      slug: 'repairs',
      type: 'service-branch',
      seoTitle: 'Ремонт одежды и изделий — Ателье 15/13',
      seoDescription: 'Ремонт одежды в Ателье 15/13: ремонт курток, кожаных изделий, верхней одежды, брендовых и люксовых вещей. Работа с фурнитурой, подкладкой, молниями.',
      h1: 'Ремонт одежды и изделий',
      introText: 'Ремонтируем куртки, кожаные изделия, верхнюю одежду, брендовые и люксовые вещи. Замена молний, подкладки, фурнитуры, реставрация ткани.',
      children: [
        {
          title: 'Ремонт верхней одежды',
          slug: 'outerwear',
          type: 'repair-category',
          seoTitle: 'Ремонт курток и верхней одежды — Ателье 15/13',
          seoDescription: 'Ремонт курток, плащей, пальто, пуховиков, парок. Замена молний, подкладки, фурнитуры. Ремонт верхней одежды в Москве.',
          h1: 'Ремонт курток и верхней одежды',
          introText: 'Ремонтируем куртки, плащи, пальто, пуховики и парки. Замена молний, подкладок, карманов, пуговиц и других элементов верхней одежды.',
          availableOptions: [
            'Замена молнии на куртке, плаще или пальто',
            'Ремонт подкладки и карманов',
            'Замена пуговиц, кнопок и фурнитуры',
            'Ремонт швов и проколов',
            'Работа с брендовой и дизайнерской одеждой',
          ],
          materials: ['Кожа', 'Натуральная шерсть', 'Синтетические ткани', 'Мембранные материалы', 'Плащевая ткань'],
          processSteps: [
            'Осмотр изделия и оценка повреждений',
            'Подбор материалов и фурнитуры',
            'Выполнение ремонта',
            'Контроль качества и выдача изделия',
          ],
        ...
        },
        {
          ...
          slug: 'leather',
          type: 'repair-category',
          seoTitle: 'Ремонт кожаных изделий и брендовой одежды — Ателье 15/13',
          seoDescription: 'Ремонт кожаных курток, сумок, перчаток. Ремонт брендовой и люксовой одежды Dior, Gucci. Реставрация кожи и фурнитуры.',
          h1: 'Ремонт кожаных и люксовых изделий',
          introText: 'Ремонтируем кожаные куртки, сумки, перчатки и другие изделия. Работаем с брендовой и люксовой одеждой: Dior, Gucci, Prada и другие марки.',
          availableOptions: [
            'Ремонт кожаных курток и сумок',
            'Ремонт брендовой и дизайнерской одежды',
            'Ремонт люксовых изделий',
            'Реставрация кожи и фурнитуры',
            'Замена молний и застёжек на коже',
          ],
          materials: ['Натуральная кожа', 'Экокожа', 'Нубук', 'Сафьяна', 'Деловая кожа'],
          processSteps: [
            'Осмотр и диагностика повреждений',
            'Подбор красителей, клея и материалов',
        ...
        {
          title: 'Ремонт головных уборов',
          slug: 'headwear',
          type: 'repair-category',
          seoTitle: 'Ремонт шляп и головных уборов — Ателье 15/13',
          seoDescription: 'Ремонт шляп, беретов, кепок и других головных уборов. Реставрация формы, замена декора, починка швов.',
          h1: 'Ремонт шляп и головных уборов',
          introText: 'Ремонтируем шляпы, береты, кепки и другие головные уборы. Восстанавливаем форму, заменяем декор, чиним швы и подкладку.',
          availableOptions: [
            'Ремонт шляп из фетра, соломки, ткани',
            'Восстановление формы головного убора',
            'Замена лент, декора и подкладки',
            'Чинка швов и проколов',
            'Работа с винтажными головными уборами',
          ],
          materials: ['Фетр', 'Соломка', 'Шёлк', 'Хлопок', 'Кожа'],
          processSteps: [
            'Осмотр и оценка состояния',
            'Чистка и подготовка материала',
