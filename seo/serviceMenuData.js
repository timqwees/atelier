...
function createSeoDescription(title) {
  return `${title} в Ателье 15/13: SEO-страница услуги с описанием, материалами, вариантами исполнения, FAQ и CTA для записи на консультацию.`;
}

function createIntroText(title) {
  return `${title} — страница услуги, подготовленная как SEO-фундамент. Здесь будет расширенное описание направления, вариантов исполнения, материалов, процесса и стоимости.`;
}
...
const womenDressSubcategories = [
  ...
  { title: 'Отрезные платья', slug: 'cut-off-waist', type: 'service-subcategory' },
  {
    ...
    seoDescription: 'Индивидуальный пошив вечерних платьев для особого дня: выпускного, свадьбы, торжества или важного мероприятия. Стоимость пошива от 80 000 ₽.',
...
function createAlterationCategory({ title, slug, genitive, genderLabel }) {
  return {
    ...
    introText: `SEO-заготовка страницы услуги: корректировка ${genitive}. Раздел относится к направлению «${genderLabel}» и будет раскрыт отдельной страницей по структуре прайс-листа.`,
    ...
    priceNote: 'Стоимость корректировки рассчитывается по прайс-листу и зависит от изделия, ткани, объёма работ и сложности обработки.',
    processSteps: [
...
export const serviceMenuData = createNode({
  ...
  seoDescription: 'Услуги Ателье 15/13: SEO-структура для индивидуального пошива, корректировки изделий и вложенных страниц по категориям одежды.',
  ...
  children: [
    {
      ...
      introText: 'Раздел для будущих SEO-страниц по подгонке, ремонту, посадке и корректировке готовых изделий.',
      children: [
        {
          title: 'Женщинам',
          slug: 'women',
          ...
          introText: 'Раздел корректировки женских изделий. Следующий уровень структуры — отдельные основы по прайс-листу.',
        ...
        },
        {
          ...
          introText: 'Раздел корректировки мужских изделий. Следующий уровень структуры — отдельные основы по прайс-листу.',
    ...
    },
    {
      ...
      introText: 'Раздел для будущих SEO-страниц по индивидуальному пошиву одежды с разделением по аудитории, изделиям и подтипам.',
      children: [
        {
          title: 'Женщинам',
          slug: 'women',
